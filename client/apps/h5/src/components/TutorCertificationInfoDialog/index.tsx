...
} from "../TutorCard/model";

/** 家教认证信息弹窗保存模式。 */
export type TutorCertificationInfoSaveMode = "edit" | "recertify";

/** 家教认证信息弹窗属性。 */
export interface TutorCertificationInfoDialogProps {
  onClose: () => void;
...
export function TutorCertificationInfoDialog({
  onClose,
  onSave,
  profileDraft
}: TutorCertificationInfoDialogProps) {
  ...
  return (
    <section className="checkout-sheet" aria-label="家教认证信息">
      <div className="sheet-backdrop" onClick={onClose} />
      <form
        className="sheet-panel tutor-certification-info-sheet mx-auto grid max-h-[82vh] max-w-[540px] gap-[12px] overflow-hidden px-[14px] pb-[calc(16px+env(safe-area-inset-bottom))] pt-[16px]"
