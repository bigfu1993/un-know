...
export function HuntingProjectDialog({
  areaOptions,
  initialProject,
  onClose,
  onSubmit
}: HuntingProjectDialogProps) {
  ...
  return (
    <section className="checkout-sheet" aria-label="创建狩猎项目">
      <div className="sheet-backdrop" onClick={onClose} />
      <form
        className="sheet-panel hunting-project-panel mx-auto grid max-h-[78vh] max-w-[540px] gap-[12px] overflow-hidden px-[14px] pb-[calc(14px+env(safe-area-inset-bottom))] pt-[14px]"
