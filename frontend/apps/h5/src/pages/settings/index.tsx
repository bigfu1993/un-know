...
} from "@pages/settings/components/SettingsPanels";
import {
  campusAreaOptions,
...
/** 设置页手机号安全弹窗模式。 */
type SecurityPanelMode = "phone" | "password";
...
export function SettingsView({ onBack }: { onBack: () => void }) {
  ...
  const [securityPanelMode, setSecurityPanelMode] = useState<SecurityPanelMode | null>(null);
    ...
    <section className="page-view grid gap-[12px]">
      ...
      <article className="flow-card settings-nickname-card p-[14px] compact">
        <div className="card-title flex items-center justify-between gap-[10px] min-w-0">
          <UserRound size={18} />
          <div className="settings-nickname-copy">
        ...
        <>
          ...
          <article className="flow-card settings-tutor-card p-[14px] compact">
            <div className="card-title flex items-center justify-between gap-[10px] min-w-0">
              ...
              <div className="settings-tutor-copy">
      ...
      <div className="card-list grid gap-[10px]">
        ...
        >
          <div className="card-title flex items-center justify-between gap-[10px] min-w-0">
            <Plus size={18} />
            <div className="settings-address-add-copy">
              <strong>新增地址</strong>
      ...
      {securityPanelMode === "phone" ? (
        <PhoneChange
          draft={phoneChangeDraft}
          onChange={setPhoneChangeDraft}
          onClose={() => setSecurityPanelMode(null)}
